...
class EntradaHelpers {
    ...
    public static function GetEntradaActiva($id_usuario) {
        ...
        $entrada = Entrada::where('hora_salida', null)->where('id_usuario', $id_usuario)->where('id_status',StatusType::TRABAJANDO)->first();
    ...
    public static function GetEntradasRegistradasDia($id_usuario) {
        $entradas = Entrada::where('id_usuario', $id_usuario)->whereDate('hora_entrada_programada', Carbon::today())->get();
